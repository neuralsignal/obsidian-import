...
* track PYSEC-2025-217 in transitive dep transformers via docling (X-CLIP checkpoint RCE, no fix available yet) ([#201](https://github.com/neuralsignal/obsidian-import/issues/201))
